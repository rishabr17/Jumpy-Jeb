...
extern const uint32_t Color32_Lerp_m750003431_MetadataUsageId;
...
extern "C"  bool Collider2D_IsTouching_m3830634229 (Collider2D_t646061738 * __this, Collider2D_t646061738 * ___collider0, const MethodInfo* method)
{
	typedef bool (*Collider2D_IsTouching_m3830634229_ftn) (Collider2D_t646061738 *, Collider2D_t646061738 *);
	static Collider2D_IsTouching_m3830634229_ftn _il2cpp_icall_func;
	if (!_il2cpp_icall_func)
	_il2cpp_icall_func = (Collider2D_IsTouching_m3830634229_ftn)il2cpp_codegen_resolve_icall ("UnityEngine.Collider2D::IsTouching(UnityEngine.Collider2D)");
...
extern "C"  Color32_t874517518  Color32_Lerp_m750003431 (Il2CppObject * __this /* static, unused */, Color32_t874517518  ___a0, Color32_t874517518  ___b1, float ___t2, const MethodInfo* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (Color32_Lerp_m750003431_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	Color32_t874517518  V_0;
	memset(&V_0, 0, sizeof(V_0));
	{
		...
		float L_17 = ___t2;
		Color32_t874517518  L_18;
		memset(&L_18, 0, sizeof(L_18));
		Color32__ctor_m1932627809(&L_18, (uint8_t)(((int32_t)((uint8_t)((float)((float)(((float)((float)L_2)))+(float)((float)((float)(((float)((float)((int32_t)((int32_t)L_3-(int32_t)L_4)))))*(float)L_5))))))), (uint8_t)(((int32_t)((uint8_t)((float)((float)(((float)((float)L_6)))+(float)((float)((float)(((float)((float)((int32_t)((int32_t)L_7-(int32_t)L_8)))))*(float)L_9))))))), (uint8_t)(((int32_t)((uint8_t)((float)((float)(((float)((float)L_10)))+(float)((float)((float)(((float)((float)((int32_t)((int32_t)L_11-(int32_t)L_12)))))*(float)L_13))))))), (uint8_t)(((int32_t)((uint8_t)((float)((float)(((float)((float)L_14)))+(float)((float)((float)(((float)((float)((int32_t)((int32_t)L_15-(int32_t)L_16)))))*(float)L_17))))))), /*hidden argument*/NULL);
		V_0 = L_18;
		goto IL_0084;
	}
